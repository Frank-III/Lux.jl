...
@inbounds function _groupnorm(X::AbstractArray{T, 4},
        G::Int,
    ...
    wait(compute_fixed_params!(_scale,
        _bias,
        C,
        K,
        mu,
...
@inbounds function _dgroupnorm(dY::AbstractArray{T, 4},
        Y::AbstractArray{T, 4},
        X::AbstractArray{T, 4},
        G::Int,
        gamma::AbstractVector{T},
        beta::AbstractVector{T},
        mu::AbstractArray{T, 5},
    ...
    groupnorm_xscale_and_bias! = _groupnorm_xscale_and_bias_kernel!(device,
        n,
        size(X_scale))
    wait(groupnorm_xscale_and_bias!(X_scale,
        bias,
        T(1 / (K * WxH)),
        mu,
        rsig,
